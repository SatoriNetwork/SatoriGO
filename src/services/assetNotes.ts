...
import type { NativeTicker } from './chain/chainParams';
...
export function isLegacyAsset(name: string, nativeTicker: NativeTicker = 'EVR'): boolean {
...
export function getAssetNote(name: string, nativeTicker: NativeTicker = 'EVR'): AssetNote | undefined {
