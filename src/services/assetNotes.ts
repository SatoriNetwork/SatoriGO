...
export function isLegacyAsset(name: string, nativeTicker: string = 'EVR'): boolean {
...
export function getAssetNote(name: string, nativeTicker: string = 'EVR'): AssetNote | undefined {
